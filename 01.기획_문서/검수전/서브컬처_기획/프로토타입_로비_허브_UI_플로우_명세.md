...
│                                                                        │
│  • 이름: [송예찬 산출물 반영 예정]                                      │
│  • 동조율: Lv. [linkRateLevel]                                         │
│  • 상태: 링크 안정 (또는 강제 각성 충격 상태)                          │
│                                                                        │
│  ┌──────────────────────────────────────────────────────────────────┐  │
│  │ 대사:                                                            │  │
│  │ “[송예찬 산출물 반영 예정]”                                      │  │
│  │ (※ currentDialogueID 연동하여 출력)                              │  │
│  └──────────────────────────────────────────────────────────────────┘  │
│                                                                        │
│  [ 출격 (Enter Session) ]   [ 다이버 / 기록 (NEW) ]   [ 창고 / 회수품 ]  │
└────────────────────────────────────────────────────────────────────────┘
```
...
│                          다이버 상세 정보 / 기록                       │
├────────────────────────────────────────────────────────────────────────┤
│  [초상화]   이름: [송예찬 산출물 반영 예정]                            │
│             동조율: Lv. [linkRateLevel]                                │
│                                                                        │
│  ────────────────────────────────────────────────────────────────────  │
│  개인 심상 기록                                                        │
│                                                                        │
│  [OPEN]  기록 01: [송예찬 제목 반영 예정] (NEW)                        │
│          → [기록 01 보기] 단추 활성화                                  │
│                                                                        │
│  [LOCK]  기록 02: ???                                                  │
│          → (비활성화 및 잠금 표시)                                      │
...
├────────────────────────────────────────────────────────────────────────┤
│  보관 중인 회수품                                                      │
│  - 마나석 x [storedManaStoneCount]                                     │
│  - 회복약 x [storedPotionCount]                                        │
│                                                                        │
│  다음 출격 소지품                                                      │
│  [슬롯 1] [equippedItemSlot1]                                          │
│  [슬롯 2] [equippedItemSlot2]                                          │
│                                                                        │
│  기억 파편                                                             │
│  - 세션 성공 시 자동으로 다이버의 개인 심상 기록 복구에 사용됩니다.     │
│    (창고에 별도 저장되지 않는 일회성 서사 자원)                          │
│                                                                        │
│  [ 소지품 설정 ]                                              [ 뒤로 ]  │
└────────────────────────────────────────────────────────────────────────┘
```
- **소지품 설정**: 보관 중인 마나석 및 회복약 수량 범위 내에서 `equippedItemSlot1`과 `equippedItemSlot2`를 셋업합니다.
...
│                                                                        │
│  설명:                                                                 │
│  장착한 소모품은 인게임 세션 중 사용 가능하며, 사용 시 수량이 차감됩니다.│
│                                                                        │
│  [ 창고에서 변경 ]                                            [ 출격 ]  │
└────────────────────────────────────────────────────────────────────────┘
```
...
│                                                                        │
│  [기록 복구]                                                           │
│  기억 파편 x [memoryFragmentCount] 자동 사용                           │
│  동조율 Lv. 0 → Lv. 1 (linkRateLevel 상승)                              │
│  개인 심상 기록 01 해금 완료!                                           │
│                                                                        │
│  [회수품 저장] (창고 인벤토리로 보관)                                  │
│  - 마나석 x [manaStoneCount] 창고 저장                                  │
│  - 회복약 x [potionCount] 창고 저장                                     │
│                                                                        │
│  ┌──────────────────────────────────────────────────────────────────┐  │
│  │ 대사:                                                            │  │
│  │ “[송예찬 산출물 반영 예정]”                                      │  │
...
기억 파편은 창고에 저장되는 일반 아이템이 아니라, 탈출 성공 시 메인 다이버의 개인 심상 기록을 복구하는 데 자동 사용되는 서사 자원입니다. 반면 마나석과 회복약은 세션에서 회수해 창고에 보관하고 다음 출격에 가져갈 수 있는 일반 회수품입니다.

이를 통해 본 프로토타입은 **`기억 파편 → 동조율 / 심상 기록`으로 이어지는 서브컬처 애착 루프**와, **`일반 회수품 → 창고 보관 → 다음 출격 준비`로 이어지는 익스트랙션 루프**를 최소 구조 하에서 견고하게 동시 검증합니다.
