...
* **역할별 세부 작업**:
  * **CP 장수영**: 리소스 적용 범위 승인, 우선순위 조정
  * **CD 우성혁**: 전체 비주얼 톤, UI 톤, 맵 분위기 검수
  * **PD 김남해**: 텍스트/대사/기록이 적용 화면과 충돌하지 않는지 확인
  * **PM 송예찬**: 리소스 목록 관리, 파일명/규격/적용 현황 체크
  * **TD 강다영**: 로비 이미지, 캐릭터 이미지, 아이템 이미지, UI 이미지, 맵 에셋 적용
* **완료 기준 (DoD)**: 리소스가 적용된 빌드파일 생성. 맵 레벨 1차 완성 및 P0 코어 루프 유지

---

### 5. 통합 / 점검 (07-03)
* **공통 마일스톤**: 리소스 적용 빌드 통합 점검
* **역할별 세부 작업**:
  * **CP 장수영**: P0.5 진입 가능 여부 1차 판단
  * **CD 우성혁**: 적용된 리소스가 게임성/가독성에 맞는지 검수
  * **PD 김남해**: 대사, 기록, 결과창 텍스트 누락 확인
  * **PM 송예찬**: 점검 결과 취합, 버그 목록화, 다음 주 QA 항목 정리
  * **TD 강다영**: 리소스 적용 후 발생한 참조 오류, UI 깨짐, 씬 연결 오류 수정
