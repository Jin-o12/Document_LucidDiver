...
| **소리** | 걷기 소리 감지 범위 | `walkNoiseRange` | `float` | 2.5 | 플레이어 걷기 소음 반응 반경 |
| **소리** | 달리기 소리 감지 범위 | `runNoiseRange` | `float` | 6.0 | 플레이어 달리기 소음 반응 반경 |
| **소리** | 총격 소리 감지 범위 | `gunNoiseRange` | `float` | 16.0 | 플레이어 사격 소음 반응 반경 |
| **소리** | 스킬 소리 감지 범위 [확장] | `skillNoiseRange` | `float` | 15.0 | [P0.5 제외 / 확장 사양] 플레이어 스킬 소음 반응 반경 |
| **소리** | 괴성 전파 범위 | `alertCryRange` | `float` | 침식 울림 전파 반경 |
