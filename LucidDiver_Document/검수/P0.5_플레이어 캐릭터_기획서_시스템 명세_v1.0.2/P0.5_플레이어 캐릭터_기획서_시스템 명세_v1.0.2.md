# P0.5_플레이어 캐릭터_기획서_시스템 명세_v1.0.2
...
| v1.0.2 | 2026.07.02 | P0.5 버전에서 구현할 스킬의 상세 데이터 구축
구르기 기능 명세 추가 |
...
| mpCost | 10.0 | 소비 MP: 10 |
| fireRange | 15.0 | 스킬 사거리: 15 |
| areaType | circle | 공격 범위 타입: ray 히트 지점을 중심으로 하는 원형 |
| areaWidth | 3.0 | 공격 범위 값: 중심 지점으로부터 반지름 3 |
...
| effectType_1 | vision | 공격 범위 내의 상호작용 가능 오브젝트 렌더링을 일시적으로 활성화하는 시야 볼륨 오브젝트가 생성됩니다. |
| effectDelay_1 | 0.5 | 0.5초 후에 시야 볼륨 오브젝트가 생성됨 |
| effectValue_1 | 2.5 | 시야 볼륨 오브젝트 유지 시간: 2.5초 |